...
# Encryption methods dictionary - used by both communication and instruction modules
ENCRYPTION_METHODS = {
    "1": "Caesar Cipher",
    "2": "DES",
    "3": "AES",
...
def generate_encryption_keys():
    """Generate encryption keys for all methods"""
    keys = {
...
def encrypt_question(question, method, keys):
